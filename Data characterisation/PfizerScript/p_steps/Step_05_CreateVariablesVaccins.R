...
after <- nrow(INF)
print(paste0(before - after," influenza vaccination dates removed because they do not fall between op_start_date and op_end_date or because the person is not in M_cohort"))
rm(before,after)
